...
id: story:service-binding-boundary
kind: story
status: implemented
title: Preserve pre-load refusals and optional host outputs in ER-backed services
refs:
- provider: ess
  reference: initiative:ess-evolution
relations:
- informed_by: story:pure-service-semantics
- serves: vision:O2
scope:
- confidence: cited
  path: CHANGELOG.md
...
- confidence: cited
  path: docs/design/models/service-binding-boundary/
- confidence: cited
