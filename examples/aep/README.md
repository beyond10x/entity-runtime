...
Eight definitions, one per lifecycle document `engineering-protocols` ships. This is **phase 1** of
...
reads the upstream documents from a committed fixture pinned at `79b641c` and compares edge sets in
