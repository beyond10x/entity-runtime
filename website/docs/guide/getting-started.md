...
cargo install --git https://github.com/beyond10x/entity-runtime \
  --tag 0.21.0 --locked entity-cli
entity --version
```

The complete definition used here is
[`examples/refund.yaml`](https://github.com/beyond10x/entity-runtime/blob/0.21.0/examples/refund.yaml).
...
curl --fail --show-error --location --max-time 30 \
  https://raw.githubusercontent.com/beyond10x/entity-runtime/0.21.0/examples/refund.yaml \
  --output refund.yaml
```
