...
cargo install --git https://github.com/beyond10x/entity-runtime \
  --tag 0.18.1 --locked entity-cli
entity --version
```

The complete definition used here is
[`examples/refund.yaml`](https://github.com/beyond10x/entity-runtime/blob/0.18.1/examples/refund.yaml).
...
curl --fail --show-error --location --max-time 30 \
  https://raw.githubusercontent.com/beyond10x/entity-runtime/0.18.1/examples/refund.yaml \
  --output refund.yaml
```
